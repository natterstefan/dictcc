...
export var getHtmlString = function (input) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4, fetch(createDictccUrl(input))];
